...
const Login = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      console.log("Successfully logged in with Google:", user.uid);
  ...
  const handleGithubLogin = async () => {
    ...
    try {
      ...
      const user = result.user;
      console.log("Successfully logged in with GitHub:", user.uid);

      alert(t('githubLoginSuccess'));
      navigate("/schemes");
    } catch (error) {
        ...
        <div className="container mx-auto px-4 py-12 flex items-center justify-center">
          <div className="max-w-4xl w-full bg-white rounded-2xl shadow-xl overflow-hidden md:flex">
            ...
            <div className="md:w-1/2 p-6 md:p-8 bg-gray-900 text-white flex flex-col justify-center">
              <h1 className="text-2xl md:text-3xl font-bold mb-4">{t('welcomeBack')}</h1>
